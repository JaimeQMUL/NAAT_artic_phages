...
while True:
    params = {
        "db": "protein",
        "term": "(uvsx OR recA)[Protein] AND txid10239[Organism:exp]",
        "retstart": retstart,
        "retmax": retmax,
        "retmode": "json"
    }
...
print("All sequences saved to 'ncbi/uvsx_sequences.fasta'")
...
print("Metadata saved to 'ncbi/uvsx_metadata.csv'")