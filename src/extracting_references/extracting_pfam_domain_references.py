...
with open("../../data/uniprot/interpro_domain_matches_metadata.json", "w") as f:
    json.dump(all_results, f, indent=2)

print(f"Downloaded {len(all_results)} entries with full metadata")

# Load your JSON metadata file from UniProt
with open("../../data/uniprot/interpro_domain_matches_metadata.json") as f:
    data = json.load(f)

# Output FASTA file
with open("../../data/uniprot/interpro_domain_matches.fasta", "w") as fasta_file:
    for entry in data:
