...
top_hits_accs=pd.read_csv('uvsx/data/curated_database/top_hits.csv')
...
# Load TM model
# path to model weights
topt_pth = 'seq2topt/model_tm_window.3_r2.0.76.pth' # you can download the weights from release v1.0.0
# define device
device = torch.device('cpu')
# define seq2Topt model
emb_dim= 320; window=3; n_head = 4; n_RD = 4;
...
df.to_csv('uvsx/data/scoring/top_hits_tp.csv', index=False)