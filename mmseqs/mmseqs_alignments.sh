...
# setting up inputs
# copying portein fasta
cp ../uvsx/data/references/P04529.fasta inputs
cp ../uvsx/data/references/7Z3M.fasta inputs
cp ../uvsx/data/references/9GBG.fasta inputs

# copying top hits database
cp ../uvsx/data/curated_database/top_hits.fasta inputs
