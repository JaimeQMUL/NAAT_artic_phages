...
do
  ...
  fasta="../../../1-DatabaseCuration/gold_standards/${id}.fasta"
...
usalign results/boltz_results_P04529_mmseqs/predictions/P04529_mmseqs/P04529_mmseqs_model_0.cif ../../../4-MolecularDynamics/structures/gold_standards/crystal/3IO5.pdb >> results/usalign_results.txt

echo "====== 7Z3M ======" >> results/usalign_results.txt
usalign results/boltz_results_7Z3M_mmseqs/predictions/7Z3M_mmseqs/7Z3M_mmseqs_model_0.cif ../../../4-MolecularDynamics/structures/gold_standards/crystal/7Z3M.pdb >> results/usalign_results.txt

echo "====== 9GBG ======" >> results/usalign_results.txt
usalign results/boltz_results_9GBG_mmseqs/predictions/9GBG_mmseqs/9GBG_mmseqs_model_0.cif ../../../4-MolecularDynamics/structures/gold_standards/crystal/9GBG.pdb >> results/usalign_results.txt
