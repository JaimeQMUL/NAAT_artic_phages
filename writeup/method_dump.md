...
of similar proteins which i believed would carry good signal of the residues in contact to help guide a good boltz
structural predicition. Alas no improvement.

## Comparing boltz predictions to alphafold.
Used USAlign to align the predicted structures to the crystal structures.
Found that Alphafold had much greater alignment with crystal structures.
